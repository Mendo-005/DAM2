...
import sys
import time
# Encontrar el path a un fichero externo
current_dir = os.path.dirname(os.path.abspath(__file__))
proceso_externo_path = os.path.join(current_dir, "procesoExterno.py")
intentos = 1
...
def main():
    ...
    try:
        while True:
            comando = [sys.executable, proceso_externo_path]
        ...
        print(f"Error: El archivo '{proceso_externo_path}' no fue encontrado.")
