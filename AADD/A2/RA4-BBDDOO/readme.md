...
Este proyecto es un ejemplo sencillo de cómo realizar operaciones CRUD (**Create, Read, Update, Delete**) sobre una base de datos orientada a objetos utilizando **DB4O** en Java.  
