...
SELECT DISTINCT  nombre_ingrediente, nombre_pizza FROM pizza P, ingrediente I;

INSERT INTO pizza(cod_pizza, nombre_pizza,precio) values (3, '4 Quesos', 7.0);
INSERT INTO pizza_ingrediente(pizzaId, ingredienteId, cantidad) VALUES (3,2,250);
-- CALL addIngredientePizza('Pollo','4 Quesos',100);
...
WHERE
    ...
    AND P.nombre_pizza = '4 Quesos';
    
SELECT nombre_ingrediente FROM  ingrediente I;