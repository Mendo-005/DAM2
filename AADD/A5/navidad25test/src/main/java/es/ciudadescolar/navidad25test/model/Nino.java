package es.ciudadescolar.navidad25test.model;
...
/**
 * Clase Nino que representa un niño que escribe cartas a Papanoel y recibe regalos entregados por Elfos
 * Un niño puede recibir varias unidades de un mismo regalo, por ejemplo, dos ositos de peluche
 */
...
public class Nino implements Serializable 
{
    ...
    public static enum Comportamiento {bueno,malo,regular}
     ...
     *      if (nino.getComportamiento() == Nino.Comportamiento.BUENO) { System.out.println("Es bueno"); }
     ...
     * 
     * @exception IllegalArgumentException Si el valor fijado no coincide con los valores del enum 
    ...
    public String toString() {
        return "Nino [id=" + id + ", nombre=" + nombre + ", comportamiento=" + getComportamiento() + ", num cartas="+ cartasPapaNoel.size()+"]";
    }
}
