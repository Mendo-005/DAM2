...
class VentanaMetodosPago extends JFrame {
    ...
    /**
     * PROCESAR EL PAGO SELECCIONADO (LÓGICA SIMPLIFICADA)
     * Este método verifica qué radio button está seleccionado y muestra el resultado
     */
    private void procesarPago() {
        String metodoPago = "";
        
        // VERIFICAR QUÉ RADIO BUTTON ESTÁ SELECCIONADO
        // Usamos .isSelected() para comprobar cada opción
        ...
        // IMPRIMIR INFO EN CONSOLA (para debug)
        System.out.println("Pago procesado: " + metodoPago + " - €35.00");
        
        // CERRAR AMBAS VENTANAS (esta y la padre)
        dispose();                // Cerrar ventana actual
        ventanaPadre.dispose();   // Cerrar ventana anterior
        
        // El programa termina cuando se cierran todas las ventanas
    }
}
